...
if __name__ == '__main__':
    ...
    if config.task_name =="GlaS_exp3":
        test_num = 80
        model_type = config.model_name
        model_path = "cch/ACC-UNet/Experiments/datasets/GlaS_exp3/"+model_type+"/"+test_session+"/models/best_model-"+model_type+".pth.tar"

    # elif config.task_name =="Clinic_exp1":
    #     test_num = 122
    #     model_type = config.model_name
    #     model_path = "cch/ACC-UNet/Experiments/datasets/Clinic_exp1/"+model_type+"/"+test_session+"/models/best_model-"+model_type+".pth.tar"


    # elif config.task_name =="Covid_exp1":
    #     test_num = 150
    #     model_type = config.model_name
    #     model_path = "cch/ACC-UNet/Experiments/datasets/Covid_exp1/"+model_type+"/"+test_session+"/models/best_model-"+model_type+".pth.tar"

    elif config.task_name =="ISIC18_exp2":
        test_num = 120
        model_type = config.model_name
        model_path = "cch/ACC-UNet/Experiments/datasets/ISIC18_exp2/"+model_type+"/"+test_session+"/models/best_model-"+model_type+".pth.tar"
    # elif config.task_name =="ISIC17_exp1":
    #     test_num = 400
    #     model_type = config.model_name
    #     model_path = "cch/ACC-UNet/Experiments/datasets/ISIC17_exp1/"+model_type+"/"+test_session+"/models/best_model-"+model_type+".pth.tar"

    elif config.task_name =="Medico_exp2":
        test_num = 120
        model_type = config.model_name
        model_path = "cch/ACC-UNet/Experiments/datasets/Medico_exp2/"+model_type+"/"+test_session+"/models/best_model-"+model_type+".pth.tar"

    # elif config.task_name =="DSB2018_exp1":
    #     test_num = 134
    #     model_type = config.model_name
    #     model_path = "cch/ACC-UNet/Experiments/datasets/DSB2018_exp1/"+model_type+"/"+test_session+"/models/best_model-"+model_type+".pth.tar"

    elif config.task_name =="BUSI_exp4":
        test_num = 130
        model_type = config.model_name
        model_path = "cch/ACC-UNet/Experiments/datasets/BUSI_exp4/"+model_type+"/"+test_session+"/models/best_model-"+model_type+".pth.tar"

    elif config.task_name =="Kmms_exp1":
        test_num = 29
        model_type = config.model_name
        model_path = "cch/ACC-UNet/Experiments/datasets/Kmms_exp1/"+model_type+"/"+test_session+"/models/best_model-"+model_type+".pth.tar"

    

    save_path  = "cch/ACC-UNet/Experiments/datasets/"+config.task_name +'/'+ config.model_name +'/' + test_session + '/'
